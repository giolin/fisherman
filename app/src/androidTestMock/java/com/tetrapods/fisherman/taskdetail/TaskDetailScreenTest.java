...
import com.tetrapods.fisherman.TestUtils;
import com.tetrapods.fisherman.data.Task;
import com.tetrapods.fisherman.di.AppComponent;
import com.tetrapods.fisherman.di.DaggerAppComponent;
import com.tetrapods.fisherman.util.EspressoIdlingResource;
...
public class TaskDetailScreenTest {
    ...
    public void resetRepository() {
        FishermanApp application = (FishermanApp) InstrumentationRegistry.getTargetContext().getApplicationContext();
